...
const detectDangerPrompt = ai.definePrompt({
  ...
  Based on the following problem description, determine if it describes a situation that could be dangerous to the user (e.g., electrical shock, gas leak, etc.).
  ...
  If \"isDangerous\" is true, the \"dangerExplanation\" field should provide a brief explanation of why the problem is dangerous and advise the user to seek professional help.
